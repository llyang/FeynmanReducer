...
static std::string strip_comments(std::string_view text)
{
  std::string result;
...
static void skip_space(std::string_view text, std::size_t& position)
{
...
static std::optional<IntegralReference> integral_at(std::string_view text,
                                                    std::size_t start)
{
...
static IntegralReference parse_integral(std::string_view text)
{
  std::size_t start = 0;
...
static void merge_header(std::string& header, const std::string& candidate)
{
  if (header.empty()) {
    header = candidate;
...
static std::vector<std::string> split_top_level(std::string_view text, char delimiter)
{
...
static std::size_t top_level_arrow(std::string_view text)
{
  int parentheses = 0;
  int brackets = 0;
  int braces = 0;
...
static std::vector<std::string> split_additive_terms(std::string_view text)
{
  std::vector<std::string> result;
  int parentheses = 0;
  int brackets = 0;
